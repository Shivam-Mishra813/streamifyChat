...
import { Link, useLocation } from "react-router";
import useAuthUser from "../hooks/useAuthUser";
// 🚨 NAYA: 'User' icon import kiya Profile ke liye
  ...
  return (
    <aside className="w-64 bg-base-200 border-r border-base-300 hidden lg:flex flex-col h-screen sticky top-0">
      ...
      <nav className="flex-1 p-4 space-y-1">
        ...
        {/* 🚨 NAYA: Profile Button yahan add kiya hai */}
        <Link
          to="/profile"
          className={`btn btn-ghost justify-start w-full gap-3 px-3 normal-case ${
      ...
      {/* USER PROFILE SECTION - (Optional trick: Tum chaho toh is poore niche wale dabbe ko bhi <Link to="/profile"> bana sakte ho future mein!) */}
      <div className="p-4 border-t border-base-300 mt-auto">
        <div className="flex items-center gap-3">
          <div className="avatar">
            <div className="w-10 rounded-full">
